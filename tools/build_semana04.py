"""Monta os arquivos consolidados da Semana 4 a partir de lotes auditáveis.

Os lotes permanecem separados durante a produção para respeitar checkpoints de
dois dias. A consolidação é mecânica: não altera conteúdo, IDs, âncoras,
gabaritos, comentários ou referências.
"""
