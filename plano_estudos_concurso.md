...
- **Arquivo local usado como base:** `CRA PARANA EDITAL.pdf`.
...
| Revisão fixa | 40min | Legislação CRA/CFA ou Administração Pública, conforme a semana |
...
- **Status:** já criada.
- **Arquivos:** `Apostila_Estudo_Semana_1_CRA_PR_Analista_Sistemas_v1_2.md` e `Apostila_Questoes_Semana_1_CRA_PR_Analista_Sistemas_v1_2.md`.
...
- **Foco:** Legislação CRA-PR/CFA aprofundada, Administração Pública, legislação correlata, RLM, Português e discursiva.
- **Tópicos do edital:** Lei 4.769/1965, Decreto 61.934/1967, Regimento Interno do CRA-PR, Código de Ética conforme edital vigente, Lei 12.514/2011, RNs CFA citadas no material, direitos fundamentais, art. 37 da Constituição, LAI, LGPD, Lei 8.429/1992, organização administrativa, atos administrativos, agentes públicos, poderes administrativos, licitação, responsabilidade civil do Estado, RLM completo e discursiva.
...
|---|---|---|---|---|---|---|
| Semana 1 | Dia 1 | Arquitetura e organização de computadores | Legislação CRA/CFA + Português | Conhecimentos do Cargo | Criado | Apostilas Semana 1 v1.2 |
| Semana 1 | Dia 2 | Sistemas operacionais | Administração Pública + Português | Conhecimentos do Cargo | Criado | Apostilas Semana 1 v1.2 |
| Semana 1 | Dia 3 | Banco de dados base e SQL | Legislação CRA/CFA + Português | Conhecimentos do Cargo | Criado | Apostilas Semana 1 v1.2 |
| Semana 1 | Dia 4 | Legislação CRA-PR/CFA | Administração Pública + Português + RLM | Legislação CRA/CFA | Criado | Apostilas Semana 1 v1.2 |
| Semana 1 | Dia 5 | Língua Portuguesa e discursiva | Legislação CRA/CFA + Administração Pública | Língua Portuguesa | Criado | Apostilas Semana 1 v1.2 |
| Semana 1 | Dia 6 | Administração Pública, RLM e revisão | Legislação CRA/CFA + caderno de erros | Administração Pública / RLM | Criado | Apostilas Semana 1 v1.2 |
| Semana 2 | Dia 1 | Redes: topologias, LAN/WAN, equipamentos | Legislação CRA/CFA + Português | Conhecimentos do Cargo | Pendente | Apostilas Semana 2 |
| Semana 2 | Dia 2 | Modelo OSI, TCP/IP, endereçamento e CIDR | Administração Pública + Português | Conhecimentos do Cargo | Pendente | Apostilas Semana 2 |
| Semana 2 | Dia 3 | Protocolos: HTTP, DNS, DHCP, SMTP, SNMP, LDAP, proxy | Legislação CRA/CFA + Português | Conhecimentos do Cargo | Pendente | Apostilas Semana 2 |
...
- quando a questão for criada, marcar como `Questão autoral no estilo Instituto Consulplan`;
